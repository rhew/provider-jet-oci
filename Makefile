...
export TERRAFORM_PROVIDER_VERSION := 4.90.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-oci
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := hhttps://releases.hashicorp.com/terraform-provider-oci/4.90.0
#port TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-null_v3.1.0_x5
